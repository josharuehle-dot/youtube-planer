...
export const translations = {
  de: {
    ...
    teamPanel: {
      ...
      subtitle: "Verwaltet euren Kanal und plant euren Content effizient an einem Ort.",
    ...
    settings: {
      ...
      accentColor: "Akzentfarbe",
      welcomeMessage: "Willkommensnachricht",
      welcomeSubmessage: "Untertext (Begrüßung)",
  ...
  en: {
    ...
    teamPanel: {
      ...
      subtitle: "Manage your channel and plan your content efficiently in one place.",
    ...
    settings: {
      ...
      accentColor: "Accent Color",
      welcomeMessage: "Welcome Message",
      welcomeSubmessage: "Subtitle (Welcome)",
